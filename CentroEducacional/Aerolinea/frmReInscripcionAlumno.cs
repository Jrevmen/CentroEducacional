...
namespace Aerolinea
{
    public partial class frmReInscripcionAlumno : Form
    {
        ...
        public frmReInscripcionAlumno(string sCodInscripcion, string sCarnet)
        {
            ...
            Boolean[] permisos;
            permisos = claseUsuario.PermisosBotones(claseUsuario.varibaleUsuario, "frmReInscripcionAlumno");
        ...
        public void funGuardarDatos(string paramcarnet)
        {
            if (MessageBox.Show("¿Desea Inscribir al Alumno?", "Confirmacion", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                ...
                claseUsuario.funobtenerBitacora(claseUsuario.varibaleUsuario, "INSERTAR", "Encabezado_inscripcion");
                limpiar();
                bloquearTodos();
            }
            else
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("¿Decea Eliminar la Inscripcion del Alumno?", "Confirmacion", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                ...
                _comando.ExecuteNonQuery();
              claseUsuario.funobtenerBitacora(claseUsuario.varibaleUsuario, "Eliminar", "Inscripcion");
                limpiar();
                bloquearTodos();
            }
            else {
